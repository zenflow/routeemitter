...
var Route = function(a, b){
    ...
    if (_.isObject(a) && _.isString(a.name) && _.isObject(a.params)){
    ...
    } else if (_.isObject(a) && _.isString(a.url)){
        self._initByUrl(a.url);
        ...
        throw new Error('invalid Route constructor arguments: '+(typeof a)+' & '+(typeof b));
    }
};
...
Route.prototype.equals = function(a, b){
    ...
    if (_.isObject(a) && _.isString(a.name) && _.isObject(a.params)){
        ...
        throw new Error('invalid Route#equals() arguments: '+(typeof a)+' & '+(typeof b));
    }
};
