...
var RouteEmitter = function(patterns, options){
    ...
    var url = self._bindToDocument && client.getDocumentLocation() || options.url;
    // initialise
    ...
    if (initialEmit){
        process.nextTick(function(){
            ...
            if (self._bindToDocument && (client.getDocumentLocation()!=url)){throw new Error('Document location changed??');}
