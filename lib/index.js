...
Route.prototype.replace = function(){
    var self = this;
    return self.router.replaceRoute(self);
};
Route.prototype.push = function(){
    var self = this;
    return self.router.pushRoute(self);
};
Route.prototype.extend = function(params){
    var self = this;
    return self.router.Route(self.name, _.assign({}, self.params, params || {}))
};
...
/**
 * Cleanup method to be called when you're done with your RouteEmitter instance.
 */
...
RouteEmitter.prototype.back = function(n){
    this.go(-(n || 1));
};
RouteEmitter.prototype.forward = function(n){
    this.go(n || 1);
};
...
RouteEmitter.prototype.replaceUrl = function(url){
    this._change(new this.Route(url), 'replace');
};
RouteEmitter.prototype.replaceRoute = function(a, b){
    this._change(this._resolveRoute(a, b), 'replace');
};
RouteEmitter.prototype.pushUrl = function(url){
    this._change(new this.Route(url), 'push')
};
RouteEmitter.prototype.pushRoute = function(a, b){
